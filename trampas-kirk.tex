...
% \resumeitem{Skills/Tools}{Netflix Tech Stack (Hystrix, Asgard, Ribbon, Eureka, Karyon, Ahchaius), git, \LaTeX, FIX, Java, JMS, maven, PowerMokito, Spring, Jenkins, Design Patterns{\tiny{\texttrademark}}, IntelliJ IDEA, Eclipse, Hibernate, h2, XPath, cobertura, AutoCAD, SVN, perforce, subersion}

\resumeitem{Skills/Tools}{Netflix Tech Stack (Hystrix, Asgard, Ribbon, Eureka, Karyon, Ahchaius), git, memcached, ElasticSearch, \LaTeX, FIX, Java, JMS, maven, PowerMokito, Spring, Jenkins, Design Patterns{\tiny{\texttrademark}}, Intellij, Eclipse, Hibernate, h2, XPath, cobertura, AutoCAD, SVN, perforce, subersion}

\negaskip

\resumeitem{Operating Systems}{UNIX, Linux, PowerMAX OS, HP/UX, OpenVMS, Windows, OS X}
...
%%%% Use Goal & Achievements to accomplish that goal!  (SMART) %%%%%%%%%%%%%%
    ...
    \resumeitem{\chimp\ Senior Application Engineer \\ Mainz Brady Group (at Nike WHC) \\  Nov 2013-Dec 2014}{
        ...
        \begin{compactList}
            % ElasticSearch
            \item Modified ElasticSearch's index configruation to improve search relevancy for searches for usern names.
        \end{compactList}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \resumeitem{Currently}{
        ...
        \begin{compactList}
            ...
            \item Hobbies include, but are not limited to: aquatic HIIT, miniature helicopters, reading, video games, cycling, and running
