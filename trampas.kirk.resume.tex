...
\shorterSection{Skills/Tools}
  ...
  \small
    \item{
     \textbf{Languages/protocols}{: Java, bash, regular expressions, \LaTeX, JMS, FIX, PL/SQL}
     \hfill
     \textbf{Tools}{: AWS, Netflix Tech Stack (Hystrix, Asgard, Ribbon, Eureka, Karyon, Archaius), gradle, Couchbase, git, UNIX/POSIX tools, memcached, maven, PowerMokito, Spring, Jenkins, Design Patterns{\tiny{\texttrademark}}, Intellij, SVN, perforce, Hibernate, SVN, perforce}
    }
    \vspace{-5pt}
    \item{
...
\shorterSection{Projects and Hobbies}
  \resumeSubHeadingListStart
  \small
    \item{Self publishing creative works on Amazon/iBooks complete with ISBNs: 1 book (fragment) done, second in progress, collaborative graphic novel(s) forthcoming}
    \vspace{-5pt}
    \item{Running (including the 2012 Tennessee Ragnar)}
    \vspace{-5pt}
    \item{Martial arts/conditioning from Karate, boxing, Mui Tha, MMA, and Jeet Kune Do, to aquatic martial arts and more}
    \vspace{-5pt}
