...
\shorterSection{Skills/Tools}
  ...
  \small
    ...
    \vspace{-5pt}
    \item{\textbf{Tools}{: AWS (EC2, Dynamo, S3, Kinesis), Kafka, groovy, spock, memsql, postgres, scylla, skinny ORM, karma, Apache Avro, Netflix Tech Stack (Hystrix, Asgard, Ribbon, Eureka, Karyon, Archaius), gradle, Couchbase, git, UNIX/POSIX tools, memcached, maven, PowerMock/PowerMockito, Spring, Jenkins/CI/CD, Design Patterns{\tiny{\texttrademark}}, Intellij, Hibernate, SVN, perforce}}
    \vspace{-5pt}
    \item{
