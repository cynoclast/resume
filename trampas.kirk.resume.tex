...
\shorterSection{Skills/Tools}
  ...
  \small
    ...
    \vspace{-5pt}
    \item{\textbf{Tools}{: Dynatrace, Datadog, AWS (EC2, Dynamo, S3, Kinesis), Kafka, groovy, spock, memsql, postgres, scylla, skinny ORM, Apache Avro, Netflix Tech Stack (Hystrix, Asgard, Ribbon, Eureka, Karyon, Archaius), gradle, Couchbase, git, UNIX/POSIX tools, memcached, maven, PowerMock/PowerMockito, Spring, Jenkins/CI/CD, Design Patterns{\tiny{\texttrademark}}, Intellij, Hibernate, SVN, perforce}}
    \vspace{-5pt}
    \item{
...
\shorterSection{Projects and Hobbies}
  ...
  \small
    ...
    % \vspace{-5pt}
    \item{Tinkering with \href{https://github.com/cynoclast/home/blob/master/.bash_profile}{\color{blue}\underline{dotfiles}}}
    %\vspace{-5pt}
