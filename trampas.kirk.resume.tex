...
\shorterSection{Skills/Tools}
  ...
  \small
    \item{
     ...
     \hfill
     \textbf{Tools}{: AWS (EC2, Dynamo, S3), Netflix Tech Stack (Hystrix, Asgard, Ribbon, Eureka, Karyon, Archaius), gradle, Couchbase, git, UNIX/POSIX tools, memcached, maven, PowerMock/PowerMockito, Spring, Jenkins/CI/CD, Design Patterns{\tiny{\texttrademark}}, Intellij, SVN, perforce, Hibernate, SVN, perforce}
    }
    \vspace{-5pt}
    \item{
