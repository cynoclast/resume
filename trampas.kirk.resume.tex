...
%----------HEADING-----------------
\begin{center}
  \small \textbf{{\huge Trampas Kirk}} \\  \vspace{2mm}\href{mailto:trampas.kirk@gmail.com}{\color{blue}\underline{trampas.kirk@gmail.com}} $\vert$
  503-898-0181 $\vert$
...
\resumeSubheading
  ...
  {Structural Detailer}{Fall 2004-Fall 2005}
  \resumeItemListStart
    \resumeItem{CAD work for a local business after graduating high school}
...
\shorterSection{Projects and Hobbies}
  \resumeSubHeadingListStart
  \small
    \item{Built a small, fast, simple program to calculate and analyze my weekly timesheet tracking and entry}
    \vspace{-5pt}
    \item{Moved my \LaTeX  resume to github (this one)}
    \vspace{-5pt}
