      ...
      \resumeItemListStart
        \resumeItem{Notifications Team}
          {Enhanced and supported a suite of Karyon based microservices that send the majority of email/sms/push notifications to users
            \begin{itemize}
                \item Added BCP 47 (international language standard) support to microservices to support sending order and marketing notifications in 33 languages in many 28
